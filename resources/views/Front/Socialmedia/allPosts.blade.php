...
{{--                                        @csrf--}}
{{--                                        <button type="submit"><span id="boot-icon" class="bi bi-heart" style="font-size: 10rem; color: rgb(255, 0, 0);"></span></button>--}}
{{--                                    </form>--}}
{{--                                @endif--}}
{{--                            @endif--}}


                            <i class="fa fa-heart white-heart {{ $post->Liked() ? 'red-heart' : '' }}" data-id="{{ $post->id }}">
