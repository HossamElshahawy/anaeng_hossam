                ...
                <div class="row row--30">
                    <div class="col-lg-8">
                        ...
                        <div class="edu-blog blog-style-list" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="{{route('show.artical',$Artical->id)}}">
                                        <img src="storage/app/{{$Artical->img}}" alt="Blog Images">
                                    </a>
                                </div>
                                <div class="content">
                                    <h5 class="title"><a href="blog-details.html">{{$Artical->title}}</a></h5>
                                    <div class="read-more-btn">
                                        <a class="edu-btn btn-border btn-medium" href="{{route('show.artical',$Artical->id)}}">يتعلم أكثر <i class="icon-west"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
