                            ...
                            <div class="row g-5">
                                <div class="col-lg-6">
                                    <div class="blog-pagination-list prev-post">
                                        <a href="#">
                                            <i class="icon-east"></i>
                                            <span>التصميم التعليمي والمتعلمين الكبار أراد أن يتجنب الألم الذي</span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="blog-pagination-list next-post">
                                        <a href="#">
                                            <span>المؤهل لمعدل رضا الطلاب أراد أن يتجنب الألم الذي</span>
                                            <i class="icon-west"></i>
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="content latest-post-list">
                                        <div class="latest-post">
                                            ...
                                            <div class="post-content">
                                                <h6 class="title"><a href="{{route('show.artical',$artical->id)}}">
                                                        {{ $artical->title}}
                                                    </a></h6>
