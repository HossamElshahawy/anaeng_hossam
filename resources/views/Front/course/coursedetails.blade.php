        ...
        <div class="container">
            <div class="breadcrumb-inner">
                ...
                <div class="page-title">
                    <h1 class="title">الهندسه المدنيه</h1>
                </div>
                <ul class="course-meta">
                    <li><i class="icon-58"></i>بواسطة حسام</li>
                    <li class="course-rating">
                        ...
                        <span class="rating-count">(٠٢٧ تقييم)</span>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="course-details-content course-details-2">
                        <div class="course-overview">
                            ...
                            <div class="border-box">
                                <h5 class="title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">ماذا ستتعلم؟</h5>
                                <div class="row g-5">
                                    <div class="col-lg-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                        <ul>
                                            ...
                                            <li>قم ببناء 6 مشاريع جميلة من العالم الحقيقي لمحفظة أعمالك (ليست تطبيقات ألعاب مملة)</li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                        <ul>
                                            <li>افهم النظرية الكامنة وراء Vue.js واستخدمها في المشروعات الحقيقية</li>
                                            <li>قم بإنشاء تخطيطات سريعة الاستجابة ويمكن الوصول </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">متطلبات</h3>
                            <ul class="mb--90" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <li>لا يلزم معرفة مسبقة بـ WordPress حيث سيتم تغطية كل شيء في هذه الدورة</li>
                                <li>تساعد المعرفة الأساسية بـ HTML و CSS ، ولكنها ليست ضرورية</li>
                                <li>لا تحتاج إلى أي خبرة في البرمجة على الإطلاق. هذا هو جمال WordPress</li>
                                <li>مطلوب معرفة أساسية بجافا سكريبت</li>
                            </ul>
                            <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">الجمهور المستهدف</h3>
                            <ul class="mb--90" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <li>الوافد الجديد بالإضافة إلى مطوري الواجهة الأمامية ذوي الخبرة المهتمين بتعلم إطار عمل JavaScript حديث</li>
                                <li>إذا كنت تريد أن تتعلم إتقان WordPress دون الانغماس في المصطلحات الفنية ، فهذه الدورة مناسبة لك</li>
                                <li>هذه الدورة مخصصة لك إذا كنت ترغب في إنشاء موقع على شبكة الإنترنت ، سواء لأسباب شخصية أو تتعلق بالعمل</li>
                                <li>هذه الدورة التدريبية مثالية لك إذا كنت تستحوذ على موقع Wordpress موجود بالفعل ، أو تريد إنشاء موقع منه</li>
                            </ul>
                        </div>
                        <div class="course-curriculam mb--90">
                            <h3 class="heading-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">مواضيع لهذه الدورة</h3>
                            <p data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">سأعرض مثال حي لهذا، من منا لم يتحمل جهد بدني شاق إلا من أجل الحصول على ميزة أو فائدة؟ ولكن من لديه الحق أن ينتقد شخص ما أراد أن يشعر بالسعادة التي </p>
...
{{--                                                    end--}}
                        ...
                        <div class="course-review" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            ...
                            <p>٠٠.٥ تصنيف متوسط ​​على أساس ٧ تصنيف</p>
                            <div class="border-box">
                                <div class="row g-0 align-items-center">
                                    <div class="col-lg-4">
                                        <div class="rating-box">
                                            <div class="rating-number">٠.٥</div>
                                            <div class="rating">
                                                <i class="icon-23"></i>
                                                <i class="icon-23"></i>
                                                <i class="icon-23"></i>
                                    ...
                                    <div class="comment-list-wrapper">
                                        ...
                                        <div class="comment">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <h5 class="title">بنان معيسة</h5>
                                                <span class="date">أكتوبر١٢٠٢,٠١ </span>
                                                <p>علي الجانب الآخر نشجب ونستنكر هؤلاء الرجال المفتونون بنشوة اللحظة الهائمون في رغباتهم فلا يدركون ما يعقبها من الألم والأسي الم</p>
                                            </div>
                                        </div>
                                        <!-- End Single Comment  -->
                                        <!-- Start Single Comment  -->
...
{{--                                        <li>--}}
{{--                                            <span class="label"><i class="icon-63"></i>المقيدين:</span>--}}
{{--                                            <span class="value"> ٥٦ الطلاب</span>--}}
{{--                                        </li>--}}
                                        <li>
                                    ...
                                    <div class="read-more-btn">
                                        <a href="#" class="edu-btn">ابدأ الآن <i class="icon-west"></i></a>
                                    </div>
