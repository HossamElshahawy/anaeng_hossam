                ...
                <ul>
                    ...
                    <li>
                        <div class="course-view-all" data-sal-delay="150" data-sal="slide-up" data-sal-duration="1200">
                            <a href="course-one.html" class="edu-btn">تصفح المزيد من الدورات <i class="icon-west"></i></a>
                        </div>
                    </li>
                </ul>
                <div class="row g-5">
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course_details.html">
                                        <img src="{{asset('lms/assets/images/course/course-11.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                                ...
                                <div class="content">
                                    ...
                                    <h6 class="title">
                                        <a href="{{route('courseview')}}">دورة  الكاملة للهندسه المدنيه  </a>
                                    </h6>
                    ...
                    <div class="col-xl-6" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-4">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course_details.html">
                                        <img src="{{asset('lms/assets/images/course/course-12.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                                        <span class="duration"><i class="icon-61"></i> ٤ أسابيع</span>
                                    </div>
                                ...
                                <div class="content">
                                    <div class="course-price">$٠٠.٩٤</div>
                                    <h6 class="title">
                                        <a href="course_details.html">إتقان علامتك التجارية الشخصية مثل محترف التسويق</a>
                                    </h6>
                                    <div class="course-rating">
                                        <div class="rating">
                                            <i class="icon-23"></i>
                    ...
                    <div class="col-xl-6" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-4">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course_details.html">
                                        <img src="{{asset('lms/assets/images/course/course-13.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                                        <span class="duration"><i class="icon-61"></i> ٤ أسابيع</span>
                                    </div>
                                ...
                                <div class="content">
                                    <div class="course-price">$٠٠.٩٤</div>
                                    <h6 class="title">
                                        <a href="course_details.html">Java Programming Masterclass لمطوري البرمجيات</a>
                                    </h6>
                                    <div class="course-rating">
                                        <div class="rating">
                                            <i class="icon-23"></i>
                    ...
                    <div class="col-xl-6" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-course course-style-4">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course_details.html">
                                        <img src="{{asset('lms/assets/images/course/course-14.jpg')}}" alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                                        <span class="duration"><i class="icon-61"></i> ٤ أسابيع</span>
                                    </div>
                                ...
                                <div class="content">
                                    <div class="course-price">$٠٠.٩٤</div>
                                    <h6 class="title">
                                        <a href="course_details.html">دورة الرسم النهائية - مبتدئ إلى متقدم</a>
                                    </h6>
                                    <div class="course-rating">
                                        <div class="rating">
                                            <i class="icon-23"></i>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <div class="section-title section-left" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                ...
                                <a href="courses.html" class="edu-btn btn-secondary">نبدأ الآن <i class="icon-west"></i></a>
                            </div>
                        </div>
                    </div>
                    <ul class="shape-group">
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{asset('assets/images/blog/blog-32.jpg')}}" alt="Blog Images">
                                    </a>
                                    <span class="date">أكتوبر,٢٢٠٢,٠١</span>
                                </div>
                                <div class="content position-top">
                                    <div class="read-more-btn">
                                        <a class="btn-icon-round" href="blog-details.html"><i class="icon-west"></i></a>
                                    </div>
                                    <div class="category-wrap">
                                        <a href="#" class="blog-category">عبر الانترنت</a>
                                    </div>
                                    <h5 class="title"><a href="blog-details.html">كن مدونًا أفضل: تخطيط الحصول مثالمثال أكتوبرأكتوبر الحصول الحصولالمحتوى</a></h5>
                                    <p>مثال حي لهذا، من منا لم يتحمل جهد بدني شاق إلا من أجل الحصول على ميزة أو فائدة</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{asset('lms/assets/images/blog/blog-33.jpg')}}" alt="Blog Images">
                                    </a>
                                    <span class="date">أكتوبر,٢٢٠٢,٠١</span>
                                </div>
                                <div class="content position-top">
                                    ...
                                    <div class="category-wrap">
                                        <a href="#" class="blog-category">محاضرة</a>
                                    </div>
                                    <h5 class="title"><a href="blog-details.html">كيف تحافظ على نشاطك في الحصول مثالمثال أكتوبرأكتوبر الحصول الصباح</a></h5>
                                    <p>مثال حي لهذا، من منا لم يتحمل جهد بدني شاق إلا من أجل الحصول على ميزة أو فائدة</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{asset('lms/assets/images/blog/blog-34.jpg')}}" alt="Blog Images">
                                    </a>
                                    <span class="date">أكتوبر,٢٢٠٢,٠١</span>
                                </div>
                                <div class="content position-top">
                                    ...
                                    <div class="category-wrap">
                                        <a href="#" class="blog-category">اعمال</a>
                                    </div>
                                    <h5 class="title"><a href="blog-details.html">أربع طرق للحفاظ على روتين التمرين مثالمثال بدني بدني الخاص بك منتعشًا</a></h5>
                                    <p>مثال حي لهذا، من منا لم يتحمل جهد بدني شاق إلا من أجل الحصول على ميزة أو فائدة</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12" data-sal-delay="300" data-sal="slide-up" data-sal-duration="800">
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="blog-details.html">
                                        <img src="{{asset('lms/assets/images/blog/blog-35.jpg')}}" alt="Blog Images">
                                    </a>
                                    <span class="date">أكتوبر,٢٢٠٢,٠١</span>
                                </div>
                                <div class="content position-top">
                                    ...
                                    <h5 class="title"><a href="blog-details.html">بدء تحسين محركات البحث كسياسة الأعمال الحصول مثالمثال الحصول المنزلية الخاصة بك</a></h5>
                                    <p>مثال حي لهذا، من منا لم يتحمل جهد بدني شاق إلا من أجل الحصول على ميزة أو فائدة</p>
                                </div>
                            </div>
                        </div>
