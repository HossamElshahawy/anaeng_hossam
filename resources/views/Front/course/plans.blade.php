            ...
            <div class="container">
                ...
                <div class="row g-5">
                    <div class="col-lg-4" data-sal-delay="100" data-sal="slide-up" data-sal-duration="800">
                        <div class="pricing-table">
                            <div class="pricing-header">
                                <h6 class="title">الخطة الفضية</h6>
                                <div class="price-wrap">
                                    <span class="amount">٠٠.٩٢$</span>
                                    <span class="duration">كل شهر</span>
                                </div>
                                <p>لكن لا بد أن أوضح لك أن كل هذه الأفكار المغلوطة حول استنكار النشوة وتمجيد الألم</p>
                            </div>
                            <div class="pricing-body">
                                <ul class="list-item">
                                    <li><i class="icon-20"></i>وشملت الدورات: ١</li>
                                    <li><i class="icon-20"></i>دورة فردية</li>
                                    <li><i class="icon-20"></i>فحوصات تعلم الدورة</li>
                                    <li class="item-off"><i class="icon-20"></i>مناقشات الدورة</li>
                                    <li class="item-off"><i class="icon-20"></i>التعلم دون اتصال بالإنترنت</li>
                                </ul>
                            </div>
                            <div class="pricing-btn">
                                <a class="edu-btn btn-border btn-medium" href="#"> اختر خطة <i class="icon-west"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="pricing-table">
                            <div class="pricing-header">
                                <h6 class="title">الخطة الذهبية</h6>
                                <div class="price-wrap">
                                    <span class="amount">٠٠.٩٤$</span>
                                    <span class="duration">كل شهر</span>
                                </div>
                                <p>لكن لا بد أن أوضح لك أن كل هذه الأفكار المغلوطة حول استنكار النشوة وتمجيد الألم</p>
                            </div>
                    ...
                    <div class="col-lg-4" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                        <div class="pricing-table">
                            <div class="pricing-header">
                                <h6 class="title">الخطة الماسية</h6>
                                <div class="price-wrap">
                                    <span class="amount">٠٠.٩٧$</span>
                                    <span class="duration">كل شهر</span>
                                </div>
                                <p>لكن لا بد أن أوضح لك أن كل هذه الأفكار المغلوطة حول استنكار النشوة وتمجيد الألم</p>
                            </div>
