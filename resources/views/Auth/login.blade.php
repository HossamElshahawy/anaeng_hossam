                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            ...
                            @endforeach
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center"><a class="btn btn-facebook" href="{{url('login/facebook')}}"><i data-feather="facebook"></i></a></i></a><a class="btn btn-google" href="{{url('auth/google')}}"><i data-feather="mail"></i></a></div>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
