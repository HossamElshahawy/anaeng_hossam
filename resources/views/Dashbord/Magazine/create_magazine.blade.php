    ...
    <div class="col-md-12">
        <div class="card">
                ...
                <div class="row">
                    <form method="POST" action="{{route('magazine.create.handle')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2 font">
                            <label class="form-label" for="phone-number"> وصف المجله</label>
                            <div class="input-group input-group-merge">

                                <input type="text" class="form-control phone-number-mask" placeholder="المجله اليوميه" name="description">
                            </div>
                        </div>
            ...
            <div class="col-xl-4 col-md-6 col-12 font">
                ...
                <button type="button" class="btn btn-warning waves-effect waves-float waves-light font">انشاء طالب جديد</button>
            </div>
